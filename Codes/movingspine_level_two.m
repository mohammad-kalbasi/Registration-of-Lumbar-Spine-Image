function spinPointCloudTransform = movingspine_level_two(V_moving,tform_rigid,label,movingCloud,vx,vy,vz)
...
pointCloudtemp = pointCloud(xyzPointslabel);
pointCloudtemp_out= pctransform(pointCloudtemp,tform_rigid);
xyzPointslabel = pointCloudtemp_out.Location;
xyzPointslabel = round(xyzPointslabel);
