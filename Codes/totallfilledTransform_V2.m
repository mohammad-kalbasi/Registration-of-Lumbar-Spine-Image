function PointCloutout = totallfilledTransform_V2(V_moving,vx,vy,vz,movingCloud,tform_rigid)
% doing exactly like it previous version but it just modified to apply a
% transform first
...
pointCloudtemp = pointCloud(xyzPoints);
pointCloudtemp_out= pctransform(pointCloudtemp,tform_rigid);
xyzPoints = pointCloudtemp_out.Location;
xyzPoints = round(xyzPoints);
